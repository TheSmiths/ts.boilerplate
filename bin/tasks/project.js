            ...
            function (done) {
                ...
                exec("mkdir " + cpDirs.libDir, function () {
                    if (options.type === 'library') {
                        exec("mkdir " + path.join(cpDirs.libDir, options.name), function () {
                            fs.writeFile(path.join(cpDirs.libDir, options.name, 'README'), readme, done);
                        });
                    } else {
            ...
            function (done) {
                ...
                exec("mkdir " + cpDirs.widDir, function () {
                    if (options.type === 'widget') {
                        exec('alloy -p ' + options.projectDir + ' generate widget ' + options.name, done);
                    } else {
